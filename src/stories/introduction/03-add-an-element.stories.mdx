...
Now you can use this [>>>MAGIC LINK<<<](https://github.com/thc-tools/feature-proposals/issues/new?assignees=Ephrame%2C+c3dr0x&labels=design+system&template=desgin_system.md&title=ToChange&projects=thc-tools/4)
...
It is made on root of thc-tools's repos and linked with `technical-proposals` and `feature-proposals`.

    ...
    parameters: {
        docs: {
            description: {
                component: `
\`\`\`js
import { Input, TextField } from "@ds-tools/design-system/molecules/inputs";
\`\`\`
                `,
            },
        },
...
export function FormProps() {
    ...
    return (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "10px" }}>
            ...
            <TextField label="Read only" readOnly value="Hello ds" />
...
function TextFieldBaseTrio(props) {
    return (
        <div>
            ...
            <TextField placeholder="Search..." id={Math.random()} startAdornment="view" {...props} />
        </div>
    );
}
...
export function Multiline() {
    ...
    return (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "10px" }}>
            <Input name="1" placeholder="Enter text here..." multiline />
            <Input name="2" placeholder="Enter text here..." multiline startAdornment="pos" />
            <Input name="3" placeholder="Enter text here..." multiline endAdornment="Kg" />
            <Input name="4" placeholder="Enter text here..." multiline value={value} onChange={onChange} />
            <Input name="5" placeholder="Enter text here..." multiline hasError startAdornment="pos" />
            <Input name="6" placeholder="Enter text here..." multiline disabled startAdornment="pos" />
        </div>
    );
}
    ...
    return (
        <div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
                <Input name="1" placeholder="Enter text here..." startAdornment="pos" />
                <Input name="2" placeholder="Enter text here..." endAdornment="pos" />
                <Input name="3" placeholder="Enter text here..." startAdornment="€" />
                <Input name="4" placeholder="Enter text here..." endAdornment="Kg" />
                <Input name="5" placeholder="Enter text here..." startAdornment="pos" endAdornment="Kg" />
                <Input name="6" placeholder="Enter text here..." startAdornment={["pos", "Kg"]} />
            </div>
        </div>
    );
}
...
\`\`\`jsx
<TextField placeholder="Enter text here..." startAdornment="pos" />
\`\`\`

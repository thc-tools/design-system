...
// Components
import { Checkbox, CheckboxField, CheckboxProps } from "../Checkbox";
    ...
    parameters: {
        docs: {
            description: {
                component: `
\`\`\`js
import { Checkbox, CheckboxField } from "@ds-tools/design-system/molecules/inputs"
\`\`\`
                `,
            },
        },
...
function Template({ checked: checkedProp, ...args }: CheckboxProps) {
...
export function CheckboxFieldStory(): JSX.Element {

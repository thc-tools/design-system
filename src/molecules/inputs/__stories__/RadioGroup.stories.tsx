...
\`\`\`js
import { RadioGroup, RadioGroupField } from "@ds-tools/design-system/molecules/inputs"
\`\`\`
                `,
            },
        },
...
function Template({ value: valueProp, options, ...args }: RadioGroupProps) {
    ...
    return (
        <>
            <div style={{ marginBottom: "10px" }}>
                Currently selected value: <span className="ds-u-text--bold">{value}</span>
            </div>

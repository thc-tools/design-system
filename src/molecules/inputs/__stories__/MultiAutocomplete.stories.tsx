    ...
    parameters: {
        docs: {
            description: {
                component: `
\`\`\`js
import { MultiAutocomplete, MultiAutocompleteField } from "@ds-tools/design-system/molecules/inputs"
\`\`\`
                `,
            },
        },
...
function Template({ value: valueProp = [], ...args }: MultiAutocompleteProps) {

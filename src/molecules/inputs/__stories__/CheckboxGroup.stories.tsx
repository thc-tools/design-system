    ...
    parameters: {
        docs: {
            description: {
                component: `
\`\`\`js
import { CheckboxGroup, CheckboxGroupField } from "@ds-tools/design-system/molecules/inputs"
\`\`\`
                `,
            },
        },
...
function Template({ value: valueProp, options, ...args }: CheckboxGroupProps) {
    ...
    return (
        <>
            <div style={{ marginBottom: "10px" }}>
                Currently selected value: <span className="ds-u-text--bold">[{value.join(", ")}]</span>
            </div>

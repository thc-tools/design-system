...
import { STATUS_ENUM, ACTION_TYPE } from "./enums";
...
export const commonTranslations = {
    ...
    // STATUS_ENUM
    [`${THC_DESIGN_SYSTEM_COMMON_TRANSLATION_KEY}.enums.STATUS_ENUM.${STATUS_ENUM.DRAFT}`]: "Draft",
    [`${THC_DESIGN_SYSTEM_COMMON_TRANSLATION_KEY}.enums.STATUS_ENUM.${STATUS_ENUM.IN_PROGRESS}`]: "In Progress",
    [`${THC_DESIGN_SYSTEM_COMMON_TRANSLATION_KEY}.enums.STATUS_ENUM.${STATUS_ENUM.PAUSED}`]: "Paused",
    [`${THC_DESIGN_SYSTEM_COMMON_TRANSLATION_KEY}.enums.STATUS_ENUM.${STATUS_ENUM.DONE}`]: "Complete !",
    [`${THC_DESIGN_SYSTEM_COMMON_TRANSLATION_KEY}.enums.STATUS_ENUM.${STATUS_ENUM.FAILED}`]: "Failed",
    // ACTION_TYPE
